...
Route::get('/contactenos','IndexController@contactenos');
Route::get('/servicios','IndexController@servicios');
Route::get('/blogg','IndexController@blogg');
Route::get('/nosotros','IndexController@nosotros');
Route::get('/servicio-automatizacion','IndexController@servicioAutomatizacion');
Route::get('/servicio-distribucion','IndexController@servicioDistribucion');
Route::get('/servicio-conectividad','IndexController@servicioConectividad');
Route::get('/servicio-integracion','IndexController@servicioIntegracion');
Route::get('/cotizacion','IndexController@cotizaciones');
Route::get('/quejas','IndexController@quejas');
Route::get('/list-products','IndexController@shop');
Route::get('/cat/{id}','IndexController@listByCat')->name('cats');
Route::get('/product-detail/{id}','IndexController@detialpro');
Route::get('/blog-detail/{id}','IndexController@detialblog');
////// get Attribute ////////////
