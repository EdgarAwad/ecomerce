...
<div class="headerv contentv">
  <div class="headerv-videov">
    <video id="videoBG" poster="poster.JPG" autoplay muted loop>
      <source src="{{ asset('img/all2.mp4') }}" type="video/mp4">
    </video>
  </div>
...
<div class="wow animate__animated animate__pulse container">
  <div class="row">
    ...
    <div class="col-sm-12 padding-right ">
      ...
      <div class="  features_items">
        ...
        <div class="container">
          <p class="text-center parrafos">Lorem ipsum dolor sit amet consectetur adipisicing elit. At aliquid accusamus animi, temporibus cumque commodi quis suscipit quas magnam, dolore facere! Dolores architecto corrupti assumenda? Nostrum sed magnam commodi totam?</p>
        ...
        <div id="myCarousel" class="wow animate__animated animate__pulse carousel slide" data-ride="carousel" style="text-align: center;">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active" style="text-align: center; background: url('img/esperemos.jpg');background-size: contain;height:300px; ">
              <h5 class="textocarrusel fuentegrande"> desarrollo</h5>
            ...
            <div class="carousel-item" style="text-align: center;  background: url('img/esperemos2.jpg');background-size: contain;height:300px; ">
              <h5 class="textocarrusel fuentegrande">Second slide label</h5>
        ...
        <div class="cajaproducto col-lg-2 col-md-6 col-5 hvr-wobble-horizontal" style="height: 400px;">
  ...
  <br>
  <section id="portfolio" style="margin: 0px;padding: 0px;">
    <div class=" fondito wow fadeInUp" style="padding: 0px; margin:0px;">

      <div class="row" style=" margin: 0px;">
        <div class="col-lg-3 col-md-3 col-6">
          <a class="portfolio-item" style="background-image: url('products/small/envios.png'); height: 160px; padding: 0px; margin:0px;">
            <div class="details">
              <h4>Envio GRATIS!!</h4>
        ...
        <div class="col-lg-3 col-md-3 col-6">
          <a class="portfolio-item" style="background-image: url('products/small/segurosi.png'); height: 160px; padding: 0px; margin:0px;" href="">
            <div class="details">
              <h4>Compra segura</h4>
        ...
        <div class="col-lg-3 col-md-3 col-6">
          <a class="portfolio-item" style="background-image: url('products/small/BANCO.png'); height: 160px; padding: 0px; margin:0px;" href="">
            <div class="details">
        ...
        <div class="col-lg-3 col-md-3 col-6">
          <a class="portfolio-item" style="background-image: url('products/small/SERVICIO.png'); height: 160px; padding: 0px; margin:0px;" href="">
            <div class="details">
...
<div class=" py-5 bg-light">
  ...
  <div class=" marketing" style="width: 100%;">
